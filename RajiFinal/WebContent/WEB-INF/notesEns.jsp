...
<div class="card">
  ...
  <div class="card-body">
           <form action="notesEns" method="get">
        <label>Mot Clé</label>
        ...
        <tr>
         ...
         <c:forEach items="${model.notes}" var="p">
           <tr>
              ...
              <td><a onclick="return confirm('Etes-vous sûr ?')" href="supprimerNotEns?id=${p.idNote }">Supprimer</a></td>
              <td><a href="editerNotEns?id=${p.idNote }">Edit</a></td>
